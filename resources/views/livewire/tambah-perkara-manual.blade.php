<div>
    ...
    <form wire:submit.prevent="simpanPerkara">
        ...
        <div class="bg-gray-300 mx-8 mb-4 p-6 rounded shadow">
            ...
            <button @click.prevent="manual = true, api = false" class="px-3 py-2 bg-yellow-400 hover:bg-yellow-500 text-white font-medium rounded">Tambah Perkara Manual</button>
            <button @click="api = true, manual = false" class="px-3 py-2 bg-gray-400 hover:bg-gray-500 text-white font-medium rounded">Tambah Perkara (CMS)</button>
                ...
                <div class="mt-4 pl-6 pr-6 pb-6">
                    <div class="flex flex-wrap gap-2">
                        <div class="grid grid-cols-8 gap-6">
                            ...
                            <div class="flex items-center col-span-3">
                                <select wire:model="perkara.{{0}}.jenis_pidana" class="border border-solid border-black focus:border-indigo-400 focus:shadow-none focus:bg-white mt-1 block w-full" name="jenis-pidana" required>
                ...
                <div class="pl-6 pr-6 pb-6 my-4">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="grid grid-cols-8 gap-6 items-center mb-2">
                            ...
                            <div class="col-span-6">
                                <select wire:model="perkara.{{0}}.jenis.{{$index}}" class="border border-solid border-black focus:border-indigo-400 focus:shadow-none focus:bg-white mt-1 block w-full" name="jenis-pidana" required>
                        ...
                        <div class="grid grid-cols-8 gap-6">
                            ...
                            <textarea wire:model.live="perkara.{{0}}.pasal_dakwaan" 
                                class="border border-solid border-black focus:border-red-400 mt-1 w-full" 
                                rows="5" required>
                            </textarea>
                            </div>
                        </div>
